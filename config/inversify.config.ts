...
Container.bind<BlackWhiteListInterface>(TYPES["components.black_white_list"]).to(BlackWhiteList);
Container.bind<CacheInterface>(TYPES.cache).to(Cache);
Container.bind<ExtractorInterface>(TYPES['components.extractor']).to(Extractor);
