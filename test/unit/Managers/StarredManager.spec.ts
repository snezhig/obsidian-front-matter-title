    ...
    describe('Test Update', () => {
        ...
        test('Should change only file items with another title and restore one original', async () => {
            ...
            const navBlocks = {
                ...
                uou: mock<Element>({
                    find: (selector: string) => selector === '.nav-file-title-content' ? contentBlocks.searchUou : null
                }),
                snork: mock<Element>({
                    find: (selector: string) => selector === '.nav-file-title-content' ? contentBlocks.fileSnork : null
                }),
            }
            items
