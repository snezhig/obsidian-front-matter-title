...
const data = [
    {
        parts: ["_basename", "title"],
        file: vault.getAbstractFileByPath("first.md"),
        expected() {
            return { _basename: this.file.basename };
        },
    },
    {
        parts: ["_basename", "title", "name", "_path"],
        file: vault.getAbstractFileByPath("second.md"),
        expected() {
    ...
    {
        parts: ["title"],
        file: vault.getAbstractFileByPath("third.md"),
        expected() {
            return {};
        },
    },
    {
        parts: ["_basename", "_path", "_name", "_extension"],
        file: vault.getAbstractFileByPath("four.md"),
        expected() {
